...
const dir = path.join(__dirname, '..', 'public', 'templates-clean', 'cetinei');
...
console.log('\n--- ACORD GDPR.docx ---');
total += processFileAll('ACORD GDPR.docx', [
  { find: '18.12.2025', replace: '{DATA_CONTRACT}' },
]);

console.log('\n--- Adresă PRIMARIE- INTERNARE.docx ---');
total += processFileAll('Adresă PRIMARIE- INTERNARE.docx', [
  { find: '07.06.2025', replace: '{DATA_CONTRACT}' },
]);
