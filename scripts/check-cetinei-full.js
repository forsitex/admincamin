...
// Personal data from clean-templates-per-camin.js for cetinei
const personalData = [
  'BUCUR MARIA', '2590621293160', 'MITILĂ ȘTEFĂNIȚĂ', '1850419297321',
  'PX', '580201',
];
...
fs.writeFileSync(path.join(__dirname, 'cetinei-full-check.txt'), output);
