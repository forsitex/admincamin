...
import { FileText, Users, Building2, Check, Heart, Stethoscope, DollarSign, Mail, Phone, MapPin, Brain, Bot, Sparkles, Zap, Shield, TrendingUp } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 drop-shadow-lg">
              Platforma <span className="text-yellow-200">AI-Powered</span> pentru Managementul Căminelor de Bătrâni
            </h1>
            <p className="text-lg sm:text-xl text-orange-50 mb-8 max-w-2xl mx-auto drop-shadow">
              Tehnologie AI de ultimă generație pentru gestionarea rezidenților, meniurilor, medicamentelor și documentelor. Automatizare completă și asistent inteligent.
            </p>
      ...
      <section id="industrii" className="py-16 sm:py-24 bg-gradient-to-br from-gray-50 to-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Funcționalități Cămin de Bătrâni</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Soluție completă pentru gestionarea rezidenților și operațiunilor
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <IndustryCard 
              ...
              title="Rezidenți"
              description="Gestionare completă rezidenți cu documente și fișe medicale"
              color="purple"
            />
            <IndustryCard 
              icon={<Brain className="w-12 h-12 text-blue-600" />}
              title="Meniu AI"
              description="Generare automată meniuri personalizate pe bază de restricții"
              color="blue"
            />
            <IndustryCard 
              icon={<FileText className="w-12 h-12 text-red-600" />}
              title="Documente"
              description="Generare automată contracte, fișe și documente legale"
              color="red"
            />
            <IndustryCard 
              icon={<Heart className="w-12 h-12 text-orange-600" />}
              title="Sănătate"
              description="Monitorizare medicamente, stări de sănătate și rapoarte medicale"
              color="orange"
            />
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              iEmpathy este platforma SaaS cu tehnologie AI de ultimă generație, dedicată căminelor de bătrâni. 
              Oferim soluții complete pentru gestionarea rezidenților, documentelor, meniurilor și sănătății. 
              Automatizare completă, analiză inteligentă și asistență AI în peste 9 domenii active.
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <StatCard number="16" label="Documente" color="purple" />
